...
//
//        Restaurant aux = new Restaurant("McDonald's", new Address("bucuresti", "Bulevardul General Gheorghe Magheru 24A"), menu);
//        restaurants.add(aux);
...
//
//        aux = new Restaurant("Pizza Hut", new Address("bucuresti","Calea Dorobanti nr. 5-7"), menu);
//        restaurants.add(aux);
//        RestaurantService.addRestaurant(aux);
//
//        return restaurants;
